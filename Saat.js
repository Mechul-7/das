...
lib.ssMetadata = [
		{name:"Saat_atlas_1", frames: [[0,0,1950,1953]]},
		{name:"Saat_atlas_2", frames: [[0,0,847,300],[0,704,167,300],[535,604,224,300],[998,0,139,300],[913,302,136,300],[911,604,142,300],[849,0,147,300],[764,302,147,300],[1051,302,88,300],[761,604,148,300],[169,704,151,300],[322,704,149,300],[535,302,227,300],[0,302,533,400]]}
];
...
(lib.CachedBmp_14 = function() {
	this.initialize(ss["Saat_atlas_2"]);
	this.gotoAndStop(0);
...
(lib.CachedBmp_1 = function() {
	this.initialize(ss["Saat_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.kdrimage441 = function() {
	this.initialize(ss["Saat_atlas_2"]);
	this.gotoAndStop(13);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.rf(["#0000FF","#000000"],[0,1],0,0,0,0,0,31.9).s().p("AklhzQCHAUCQABQCfAACVgbIkuDzg");
	this.shape.setTransform(179.65,362.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.rf(["#9999FF","#000000"],[0.341,1],0,0,0,0,0,195.3).s().p("AaGM7QAAq2nrnqQnqnrq1ABQq3gBnrHrQnpHqAAK2QAABSAHBRQhyj7AAjkQAAk5CMkeQCIkVD3jUQD4jWFAh1QFNh5FqAAQFsAAFMB5QFAB1D4DWQD3DUCIEVQCMEeAAE5QAAD5iAEOQALhkAAhng");
	this.shape_1.setTransform(178.725,103);
...
p.nominalBounds = new cjs.Rectangle(-50.8,-50.8,101.69999999999999,101.69999999999999);
...
if (reversed == null) { reversed = false; }
	...
	// Katman_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#6666FF").s().p("EhUkBUlMAAAipJMCpJAAAMAAACpJg");
	this.shape.setTransform(0.025,0.025);
...
p.nominalBounds = new cjs.Rectangle(-541.3,-541.3,1082.6999999999998,1082.6999999999998);


(lib.saniye = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Katman_1
	this.shape = new cjs.Shape();
	this.shape.graphics.rf(["#9999FF","#000000"],[0.341,1],0,0,0,0,0,211.2).s().p("EgB+AgFQg0g0AAhKQAAhKA0g0QAagaAggOIAIgDMAAAg7/QAagYAiAAQAjAAAaAZMAAAA77QgZgHgbAAIgEAAQAZAAAWAHQAqAMAgAiQA1A0AABKQAABKg1A0Qg0A1hKAAQhJAAg1g1g");
	this.shape.setTransform(0.025,-192.675);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.saniye, new cjs.Rectangle(-17.8,-403.2,35.7,421.09999999999997), null);


(lib.saat = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Katman_1
	this.shape = new cjs.Shape();
	this.shape.graphics.rf(["#9999FF","#000000"],[0.341,1],0,0,0,0,0,151.3).s().p("AggXpIAAifQg6gJgrgsQgggfgNgoMAAAgn9QBJi5BmAAQBmAABJC9IAHATMAAAAneQgNAsgjAjQgqArg4AJIAACgg");
	this.shape.setTransform(0,-151.475);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.saat, new cjs.Rectangle(-17.9,-302.7,35.8,302.5), null);


(lib.dakika = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Katman_1
	this.shape = new cjs.Shape();
	this.shape.graphics.rf(["#9999FF","#000000"],[0.341,1],0,0,0,0,0,183.2).s().p("AggcoIAAjQQghgNgagmQgig0gEhGMAAAgwzIAOglQAwh6BFAAQBGAAAxB6IAJAZMAAAAxyQgKAngWAgQgcAqgmAMIAADNg");
	this.shape.setTransform(0,-182.725);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.dakika, new cjs.Rectangle(-13,-365.9,26,366.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		/* Bu Karede Dur
		Zaman çizelgesi bu kodu eklediğiniz karede durur/duraklatılır.
		Ayrıca, film kliplerinin zaman çizelgesini durdurmak/duraklatmak için kullanılabilir.
		*/
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		*/
		...
		function updateClock() {
		    ...
		    exportRoot.saat_txt.text = hours + ":" + minutes;
		    exportRoot.saat_txt.textAlign = "center"; // Saati ortala
		    ...
		    exportRoot.tarih_txt.text = day + " " + month + " " + year;
		    exportRoot.tarih_txt.textAlign = "center"; // Tarihi ortala
		    
		    // 3. Gün
		    var days = ['Pazar', 'Pazartesi', 'Salı', 'Çarşamba', 'Perşembe', 'Cuma', 'Cumartesi'];
		    exportRoot.gun_txt.text = days[now.getDay()];
		    exportRoot.gun_txt.textAlign = "center"; // Günü ortala
		}
	...
	this.frame_1 = function() {
		...
		*/
		...
		function updateClock() {
		    ...
		    // Ters yön için açıları negatif yaptık
		    var secondAngle = (seconds + milliseconds / 1000) * -6;   // Saniye (smooth + ters)
		    var minuteAngle = (minutes + seconds / 60) * -6;          // Dakika (ters)
		    var hourAngle   = (hours + minutes / 60 + seconds / 3600) * -30; // Saat (ters)
		    
		    // Kolları döndür
		    root.saniye.rotation = secondAngle;
		    root.dakika.rotation = minuteAngle;
		    root.saat.rotation = hourAngle;
		}
	...
	// dugme
	this.button_2 = new lib.Sembol1();
	this.button_2.name = "button_2";
	this.button_2.setTransform(540,540);
	this.button_2.alpha = 0;
	this.button_2._off = true;
	new cjs.ButtonHelper(this.button_2, 0, 1, 2, false, new lib.Sembol1(), 3);
	...
	this.saniye.setTransform(540,540);
	...
	this.dakika.setTransform(540,540,0.8269,1);
	this.dakika.alpha = 0.75;
	this.dakika._off = true;

	this.timeline.addTween(cjs.Tween.get(this.dakika).wait(1).to({_off:false},0).wait(1));

	// saat
	this.saat = new lib.saat();
	this.saat.name = "saat";
	this.saat.setTransform(540,540,1,1.0449);
	this.saat.alpha = 0.75;
	this.saat._off = true;
...
an.compositions['E64733B41E51C4488E85AB67E238EE62'] = {
